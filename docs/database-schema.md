...
erDiagram
    ...
    quotes {
        ...
        varchar planning_type "varchar(255), nullable"
        boolean disable_analytics_audit "default false, nullable"
    }
...
| `planning_type` | `varchar(255)` | yes | — |  |
| `disable_analytics_audit` | `boolean` | yes | `false` |  |
...
- `backend/docs/quote-database-diagram.md`
  - `quotes` lists dropped columns: development_types, people_count, waste_water_treatment_works_id, waste_water_treatment_works_name
  - `quotes` omits columns: planning_type, disable_analytics_audit
