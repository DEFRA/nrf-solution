...
## Cross-repo PR dependencies & PR descriptions

See [docs/contributing.md](./docs/contributing.md) for `Depends-On` conventions (full PR URL, lines go last) and PR description rules (no "Test plan" section).
